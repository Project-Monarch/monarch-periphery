...
import UniswapV2Factory from '@project-monarch/core/build/UniswapV2Factory.json'
import IUniswapV2Pair from '@project-monarch/core/build/IUniswapV2Pair.json'
